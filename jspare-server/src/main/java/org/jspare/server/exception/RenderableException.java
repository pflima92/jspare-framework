 ...
 * @since 05/10/2015
 */
public class RenderableException extends InfraException {
	 ...
	 *            the cause
	 */
	public RenderableException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *            the e
	 */
	public RenderableException(Throwable e) {
		super(e);
	}
}